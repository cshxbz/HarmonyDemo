...
export default class EntryAbility extends UIAbility {
  ...
  private targetPageUrl: string = null
  private currentWindowStage: window.WindowStage = null
  ...
  parseTargetPageByWant(want: any) {
  ...
  loadContentByTargetPage(windowStage: window.WindowStage) {
    let shouldLoadPageUrl: string = null
